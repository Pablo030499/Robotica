...
void SpecificWorker::initialize()
{
	...
	else
    {
        ...
        horizontalSlider_wall_distance->setValue(params.MIN_WALL_DISTANCE);
        lcdNumber_wall_distance->display(params.MIN_WALL_DISTANCE);
        ...
        connect(horizontalSlider_wall_distance, &QSlider::valueChanged, [this](int value)
            {
                params.MIN_WALL_DISTANCE = value;
...
SpecificWorker::RetVal SpecificWorker::turn(auto &points)
{
    ...
    static std::uniform_int_distribution<int> n_turns(5, 7);
...
SpecificWorker::RetVal SpecificWorker::spiral(auto &points) {
    ...
    static float velocidad_adv = 200.f;
